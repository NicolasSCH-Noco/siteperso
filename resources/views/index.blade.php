        ...
        <div class="container px-6 py-10 mx-auto">
            <div class="xl:flex xl:items-center xL:-mx-4">
                <div class="xl:w-1/2 xl:mx-4">
                    <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-gray-900">Qui suis-je ?</h1>
                    
                    <p class="max-w-2xl mt-4 text-gray-500 dark:text-gray-900">
                    Je suis un jeune passionné par l'informatique. Possédant une grande curiosité et un grand intérêt pour les nouvelles technologies, je suis actuellement en formation au Lycée Gaston Berger. Titulaire d'un bac pro SEN Option C (RISC). Je suis en capacité de me débrouiller dans le domaine des infrastructures réseaux et de la maintenance.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-2 text-center">  
                    <div>
                        ...
                        <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-black">Nicolas SCHARRE</h1>
                        
                        <p class=" items-center mt-4 text-gray-500 capitalize dark:text-gray-900">Développeur Back-end | Web | Applicatif </p>
                    </div>
                </div>
            </div>
        </div>
