        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form action="{{ route('register') }}" method="post" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="pb-2 pt-4">
                        <input type="text" name="name" id="name" placeholder="Nom d'utilisateur" class="block w-full p-4 text-lg rounded-sm bg-black">
                    </div>
                    <div class="pb-2 pt-4">
                    ...
                    <div class="pb-2 pt-4">
                        <input class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password_confirmation" id="password_confirmation" placeholder="Mot de passe de confirmation">
                    </div>
                    <div class="text-right text-gray-400 hover:underline hover:text-gray-100">
                        <a href="#">Mot de passe oublié ?</a>
                    </div>
                    <div class="px-4 pb-2 pt-4">
                        <button class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">Inscription</button>
                    </div>
